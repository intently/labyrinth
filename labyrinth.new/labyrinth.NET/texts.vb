...
Option Explicit On
Module texts
	Public Function CityName(ByRef Size As Short) As String
		If Size = 3 Then
			CityName = "Centris"
		Else
	...
	Public Function CityNameFirst(Optional ByRef Size As Short = 0) As String
		Dim r As Short
		r = Int(Rnd() * 78)
	...
	Public Function CityNameLast(ByRef Size As Short) As String
		Dim r As Short
		r = Int(Rnd() * 15)
	...
	Public Function CityDesc(ByRef Size As Short) As String
	...
	Public Function RegionName(ByRef r As Short) As Object
		RegionName = RegionNames(r)
	End Function
	
	Public Function UseEle(ByRef s As String, ByRef c As Short) As String
		...
		End If
	End Function
	Public Function JustText(ByRef s As String) As String
		Dim temp As String
	...
	Public Function PadSpaces(ByRef s As String, ByRef n As Short) As String
		Dim i As Short
